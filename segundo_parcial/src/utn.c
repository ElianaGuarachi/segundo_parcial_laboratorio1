...
static int esNombreDeArchivo(char cadena[], int limite);
//-------------------------------------------------------------------------------------------------
...
static int esNumerica(char* cadena, int limite)
{
	...
	for(i=0; i< limite && cadena[i] != '\0'; i++)
	{
		...
		if(cadena[i] > '9' || cadena[i] < '0' || (i == 0 && cadena[i] == '\n'))
		{
			retorno= 0;
			break;
		}
...
//======================================================================================
int ObtenerNombreDeArchivo(char texto[], char mensaje[], char mensajeError[], int reintentos)
{
	int retorno = 0;
	...
	if(texto != NULL && mensaje != NULL && mensajeError != NULL)
	{
		do{
			...
			fflush(stdin);
			scanf("%[^\n]", bufferString);
			if(esNombreDeArchivo(bufferString,sizeof(bufferString)))
			{
				strcpy(texto, bufferString);
				retorno=1;
				break;
	...
	for(i=0; i< limite && cadena[i] != '\0'; i++)
		{
			if(cadena[i] == 95 ||
				cadena[i] == 45  ||
				(cadena[i]> 47 && cadena[i]<58) || (i!=0 && cadena[i] == 32))
			{
				continue;
			}
